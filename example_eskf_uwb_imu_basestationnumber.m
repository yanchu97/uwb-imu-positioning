...
for k=1:M
    for n=1:N
        dnlos=rand();
       if dnlos<=NLOS_P
           Dmes(n,k)=range(n,k)+exprnd(NLOS_exp,1,1)+normrnd(0,los_sigma,1,1);
...
plot(1:8,RMSE_Mean_E_tightlycoupled(1:8),'c-o');grid;
xlabel('The number of base stations '); ylabel('RMSE/m');
